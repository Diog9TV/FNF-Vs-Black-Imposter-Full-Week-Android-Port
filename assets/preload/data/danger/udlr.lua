...
local xx2 = 1700; -- Same code as above, but for boyfriend left, right
local yy2 = 550; -- Same code as above, but for boyfriend up, down
local xx3 = 100; -- Same code as above, but for girlfriend left, right
local yy3 = 100; -- Same code as above, but for girlfriend, up, down
